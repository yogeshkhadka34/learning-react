...
const test = () => {
  return (
    <div >
        ...
        <h1 className="shoe__hero--title">Regain your confidence on the court</h1>
        <p className="shoe__hero--content">The shoe built with purpose and to take your game to next level</p>
        <svg width="16" height="132" viewBox="0 0 16 132" fill="none" xmlns="http://www.w3.org/2000/svg">
